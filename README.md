...
**Hello Rails Backend** is an implemention of a connection between Ruby on Rails back-end and React front-end. [Hello Rails Backend](https://github.com/jonas-45/hello-rails-back-end) handles the backend API, and [Hello React Frontend](https://github.com/jonas-45/hello-rails-front-end) handles the frontend UI to display a random greeting message.
...
Feel free to check the [issues page](https://github.com/jonas-45/hello-rails-back-end/issues).
